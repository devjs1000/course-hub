...
const CourseCard = ({
	...
	return (
		<ErrorBoundary fallback={'error in course page'}>
			<div className="rounded-sm relative w-[21rem] shadow-md overflow-hidden">
				...
				<div className="relative px-8 py-10 bg-white text-slate-900 flex flex-col items-start gap-4">
					...
					<div className="flex items-center justify-between w-full">
						<Link
							to={`coursedetails/${id}`}
							className="block mt-2 bg-primary-color-light text-white py-[.35rem] px-3 font-semibold rounded-sm hover:bg-red-500 transition-all"
						>
							See More &#8594;
						</Link>
