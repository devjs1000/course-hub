...
const Profile = () => {
    ...
    const profileDesign={
        mainDiv:'grid grid-cols-12 gap-3 p-3 my-3 mx-3 md:mx-12',
        leftMain:'col-span-12 md:col-span-4 lg:col-span-3  p-4 h-fit',
        ...
        mainBtn:'ease-in duration-200 w-full flex items-center mt-3 hover:bg-red-700 hover:text-white py-1 rounded-lg shadow-2xl cursor-pointer',
        mainIcon:'mx-2 text-red-700 w-8 h-8 p-1 bg-white rounded-full',
        mainBtnText:'text-md font-bold',
        rightMain:'col-span-12 md:col-span-8 lg:col-span-9 shadow-2xl p-4 rounded-lg h-fit',
