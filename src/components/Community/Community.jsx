...
const Community = () => {
  const posts=[
    {category:'Frontend', question:'life is full of fun when you enjoy it fully', answers:['yes good', 'right man keep it up', 'wow woooh']},
    {category:'Frontend', question:'life is full of fun when you enjoy it fully', answers:['yes good', 'right man keep it up', 'wow woooh']},
    {category:'Frontend', question:'life is full of fun when you enjoy it fully', answers:['yes good', 'right man keep it up', 'wow woooh']},
    {category:'Frontend', question:'life is full of fun when you enjoy it fully', answers:['yes good', 'right man keep it up', 'wow woooh']},
    {category:'Frontend', question:'life is full of fun when you enjoy it fully', answers:['yes good', 'right man keep it up', 'wow woooh']},
...
{Children.toArray(posts.map(a=>{
  return <Post question={a.question} category='Frontend' answers={a.answers} />
}))}
        </div>
      </div>
    </div>
